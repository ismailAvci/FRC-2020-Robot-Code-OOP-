...
/**
 * FRC 2020 Renk Sensörü kodu
 */
public abstract class ColorSensor {
    ///////renk sensörümüzü ve renkleri eşleştiren sistemi tanmladık///////
    ...
    public static void putColor(){
        SmartDashboard.putString("Detected Color", ReturnColor());
    }
}
